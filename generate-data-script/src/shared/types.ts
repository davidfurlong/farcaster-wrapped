...
export type MixedNotification =
  | (Notification & { is_unseen: boolean })
...
//   email: string;
//   subscriptions: {
//     weekly_cove_updates?: Record<string, boolean>;
//   };
//   is_suppressed: boolean;
//   created_at: string;
//   updated_at: string;
//   management_secret_token: string;
// }
...
export const feedQueryStrictTypesWithFallback = {
  type: (value: FeedItemType): FeedItemType =>
    ["cast", "profile", "text"].includes(value) ? value : "cast",
};
...
export type FeedItemType = "cast" | "profile" | "text";
export type FeedItem = FCCast | FCProfile | TextItem;
export type FeedType = Array<FCCast | FCProfile | TextItem>;
